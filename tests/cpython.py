...
import dispyatcher
from dispyatcher import CallSite, IdentityHandle, SimpleConstantHandle, IgnoreArgumentsHandle
...
class RepackTests(unittest.TestCase):
    ...
    def test_tuple_unpack_int(self):
        ...
        tud = TupleUnpackingDispatcher(IgnoreArgumentsHandle(SimpleConstantHandle(i32, -1), 0, PY_OBJECT_TYPE), 0)
    ...
    def test_tuple_unpack_double(self):
        ...
        tud = TupleUnpackingDispatcher(IgnoreArgumentsHandle(SimpleConstantHandle(dbl, -1), 0, PY_OBJECT_TYPE), 0)
